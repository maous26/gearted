...
void main() {
  ...
  print('  ✅ Original Price (nullable): $originalPrice');
  ...
  print('  ✅ Original Price: $originalPrice2');
  ...
  for (int i = 0; i < mixedListings.length; i++) {
    ...
    print('    - Original Price: ${itemOriginalPrice ?? 'null'}');
  ...
  print(
      '    - Original Price: ${listingForService['originalPrice'] ?? 'null'}');
